...
const directoryPath = path.join(process.cwd(), 'Orb-Gif');
const targetPath = path.join(process.cwd(), 'public/assets/animations/orb');
...
fs.readdir(directoryPath, (err, files) => {
    ...
    console.log(`Processed ${jpgFiles.length} frames for Orb.`);
});
